    ...
    >
      <div className="relative w-full">
        ...
        <div className="absolute top-4 right-4 py-1 px-3 bg-white rounded-full flex items-center gap-2">
          ...
          <span className="text-sm">{t('main.shelters.safeTravel')}</span>
        </div>
      </div>
      <div className="p-4 w-full">
        ...
        <div className="flex items-center gap-2 mt-1">
          ...
          <span className="text-gray-600">
            {t('main.shelters.distance', { distance, duration })}
          </span>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="fixed top-0 left-0 right-0 z-10 bg-white p-4 flex items-center gap-4">
        ...
        <h1 className="text-xl font-semibold">{t('main.shelters.title')}</h1>
      </div>
